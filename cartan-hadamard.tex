...
is an example of a simply connected space that  is locally $\CAT(1)$ but not $\CAT(1)$ (prove the latter!).
\begin{figure}[ht!]
\vskip0mm
\centering
...
in particular, this surface does not satisfy the assumption of the globalization theorem.
