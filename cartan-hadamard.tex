...
Recall that a constant-speed parameterization of a local geodesic by the unit interval $[0,1]$ is called a \index{geodesic!local geodesic}\emph{local geodesic path}. 
...
By \eqref{ex:convex-dist} and \eqref{ex:CAT-geodesic} geodesic paths in a complete geodesic $\CAT(0)$ space  depends uniquely and continuously on their end points.
...
Since $\spc{B}=\cBall[\gamma_\infty(t),R]$ is a complete geodesic $\CAT(0)$ space, by above
