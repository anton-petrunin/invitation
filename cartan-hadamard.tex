...
Observe that by  and \eqref{ex:convex-dist} and \eqref{ex:CAT-geodesic}  geodesic paths in a complete geodesic  $\CAT(0)$ space  depends uniquely and continuously on their end points. The same is true in $\CAT(1)$ spaces for geodesic paths shorter than $\pi$.
...
The lemma about patchwork along a geodesic \eqref{lem:patch} and its proof were suggested to us by Alexander Lytchak.  
