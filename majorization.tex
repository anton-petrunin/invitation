...
This theorem is a useful tool for $\CAT(0)$ spaces.
...
The last step in our proof essentially use that the space is proper.
But the theorem holds for any geodesic $\CAT(0)$ space \cite[9.56]{alexander-kapovitch-petrunin-2025}.
...
Another proof can be built on on the following closely related theorem; see \cite{lang-schroeder,alexander-kapovitch-petrunin-2011,alexander-kapovitch-petrunin-2025},
but this proof works only for complete spaces.

\begin{thm}{Generalized Kirszbraun's theorem}
\label{thm:kirsz+}
Let $\spc{U}$ be a complete length $\CAT(0)$ space, 
let $Q$ be arbitrary subset of a Euclidean space~$\EE^m$.
...
The isoperimetrical inequality is known for 3- and 4-dimesnional \emph{Hadamard manifolds} (that is, $\CAT(0)$ Riemannian manifolds).
First the 4-dimensional case was proved by Christopher Croke \cite{croke},
and latter Bruce Kleiner proved the 3-dimensional case \cite{kleiner-1992}.
