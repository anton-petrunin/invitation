...
\begin{thm}{Exercise}
Show that one-point set $\{p\}$ in a proper length $\CBB{}{\kappa}$ space forms an extremal set if and only if the space of directions $\Sigma_p$ has diameter at most $\tfrac\pi2$.
\end{thm}

\begin{thm}{Exercise}
Show that the union of two extremal sets is extremal. 
\end{thm}

\begin{thm}{Proposition}
Intersection of two extremal sets is extremal.
\end{thm}
