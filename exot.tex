...
% what case is left as an exercise? this is unclearly stated
\parit{Only-if part.}
...
A small neighborhood of $p$ is isometric to a neighborhood of the tip of $\Cone\Sigma_p$ (of  $\Susp \Sigma_p$ if $\spc{P}$ is spehrical). 
...
%Anthony Genevois has put out a pamphlet full of median-graph propaganda \cite{genevois}.
