...
Let $A_1,A_2,\ldots, A_n$ be a finite collection of closed convex sets in~$\EE^m$.
...
then we declare that $\gamma$ dies right before $t$ (that is, $\gamma$ is not defined at $t$).}
