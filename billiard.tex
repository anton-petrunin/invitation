...
$F\:\tilde D\to \dot D$ (in other words, distance-nonexpanding or 1-Lipschitz) that sends
\begin{align*}
\tilde p&\mapsto \dot p,
&
\tilde x&\mapsto \dot x,
...
defined by $x_k\mapsto\check x_k$ is well-defined and short.
...
\caption{Unit sphere in $\ddot{\spc{R}}$.}
\label{pic-870}
\end{figure}
