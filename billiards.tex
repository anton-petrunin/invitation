...
\begin{wrapfigure}[4]{r}{21mm}
\begin{lpic}[t(-12mm),b(0mm),r(0mm),l(0mm)]{pics/local-geod(1)}
\lbl[t]{2.5,1;$\gamma(0)$}
\lbl[b]{10,14;$\gamma(a)$}
\lbl[t]{19,8;$\gamma(b)$}
\end{lpic}
...
Then the gluing of $\spc{U}^1$ and  $\spc{U}^2$ along $\iota$ is a proper length $\Cat{}{0}$ space.
\end{thm}
