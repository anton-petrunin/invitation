...
It also admits natural generalization to $\Cat{}{\kappa}$ spaces, our book \cite{AKP} for details.%??? MORE REFS???

The idea described above has number of applications to the billiards.
In particular, it can be used bound topological entropy of the billiard flow, see \cite{BFK-2}.
The lecture \cite{burago-icm} gives a short survey on the subject.


Note the walls in the puff pastry plays a key role in the proof
