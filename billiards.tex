...
In fact it does not even matter which definition of convergence for metric spaces you use, as long as any quadruple of points in the limit space can be arbitrary well approximated by the quadruples in the sequence of metric spaces. 
...
plays the central role in the theory.  It will lead to two fundamental constructions: patchwork globalization  (\ref{thm:alex-patch}) 
