...
%Show that the distance function $\dist{p}{}{}$ for any point $p$ in a  $\Cat{}{0}$ proper length space is convex.
%??? that's a basic property of CAT(0) spaces. I think we should mention it somewhere. V.
% I mentioned it in Cor 2.2.5 and commented it out here. S.
...
\end{thm}
%??? Should Exercises 2.2.11 - 2.2.13 be moved up to follow Corollary 2.2.6? S.
...
Show that all intersections of $A^i$ have $\eps$-wide corners for some positive $\eps$.%%%???please check my English and remove this comment
\end{thm}

\begin{thm}{Exercise}\label{ex:centrally-simmetric-walls}
Assume $A^1,\dots,A^n\subset\EE^m$ are
convex sets with nonempty interior which have common center of symmetry.
Show that all intersections of $A^i$ have $\eps$-wide corners for some positive $\eps$.%%%???please check my English and remove this comment
\end{thm}
