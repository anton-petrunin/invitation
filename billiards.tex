...
we assume that $\Cat{}{1}$ comparison automatically holds.
...
In particular the limit of $\Cat{}{\kappa}$ spaces is a $\Cat{}{\kappa}$; it does not even matter which definition of convergence for metric spaces you use as far as any quadruple of points in the limit space can be arbitrary well approximated by the quadruples in the sequence of metric spaces. 
