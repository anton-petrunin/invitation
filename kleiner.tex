...
that is, $\bm{\mu}\z=(\mu_0,\ldots,\mu_k)\in\triangle^k$ if $\mu_0+\ldots+\mu_k=1$ and $\mu_i\ge0$ for all $i$.
...
and $\bm{f}\z=(f_0,\z\ldots,f_k)\:\spc{X}\z\to\RR^{k+1}$
...
Denote by $\bar V$ the closure of $V$; see figure~\ref{pic-1106}.
...
\parit{Proof.}
Let $\proj\:\RR^{k+1}\to\Pi$ be orthogonal projection to the hyperplane $x_0+\z\ldots+\nobreak x_k=0$.
