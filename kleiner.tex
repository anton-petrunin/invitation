...
is called barycenter of point array $\bm{p}=p_0,\dots,p_k$ with masses $\bm{m}\z=(m_0,\dots, m_k)\in \triangle^k$.
Equivalently, 
...
The map $\spx{}\:\triangle^k\mapsto \EE^n$ defined by $\spx{}\:\bm{m}\mapsto z$ is called barycentric simplex of the array $\bm{p}$.
