...
This will be the only way we will use the $\CAT(0)$ condition for most of this chapter.
...
The invariants satisfying the following two statements \ref{dim-axiom-norm} and \ref{dim-axiom-sigma} are commonly called  the \index{dimension}\emph{dimension};
...
He also proved the dimension theorem;
a more exact statement is due to Alexander Lytchak \cite{lytchak:diff}.

Bruce Kleiner made a conjecture that the dimension theorem holds for arbitrary complete geodesic $\CAT(\kappa)$ spaces see \cite{kleiner} and also \cite[p.~133]{gromov:asymt-inv}.
