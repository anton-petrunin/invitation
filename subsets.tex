...
Each set $V_t$ is a solid paraboloid tangent to $\partial C$ along the parabola $y\z\mapsto(t,y,t^2-y^2)$;  see figure~\ref{pic-1201}.
...
If $\gamma$ is a simple closed curve in $W\z\cap K$
...
Since $\eps$ is small, we can assume that all $V_s$ are convex subsets of~$\EE^m$.
...
Consider the sequence of sets (figure~\ref{pic-1206})
\[K_n
=
...
which remains on the boundary of~$P'$ (figure~\ref{pic-1209}).
