...
\footnote{ \color{red} V: the figure needs to be added}
...
instead one can assume that the induced length metric takes finite values at all points of~$\Omega$.\footnote{\color{red} V: what does that mean? }
