...
Arguing as in \ref{sec:solid-parabolonds}, we get that the following claim implies \ref{K'-is-CAT}.
\begin{clm}{}
All $W^i$ are $\CAT(0)$.
\end{clm}
...
Let $K$ be a closed subset of the unit sphere $\mathbb{S}^2$ that does not contain a closed hemisphere.
...
Then $K$ with the induced length metric is $\CAT(0)$ if and only if the interior of $K$ is two-convex and simply connected.
\end{thm}
...
For more on the subject, see \cite{petrunin-stadler,lytchak-wagner} and the references therein.
