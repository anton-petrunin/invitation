...
Let $\bar S$ be the closure of $S$ and let $L=\partial_{\partial\Omega'}\bar S$.

\begin{subthm}{ex:convex+saddle+broken=>PL:a}
Show that (1) and (2) imply that any point $p\in S$ lies in a line segment in $\bar S$ with ends in $L$ or in a polygon in $\bar S$ with vertices in~$L$.
\end{subthm}
