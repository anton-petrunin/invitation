...
%??? I do not like ``the essesnce...space'', is it a quote?, why do we need it here, whay not to say ``curvature can be described via 6 distances between quadruples of points of a metric space''A. ???
