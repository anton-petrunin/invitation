...
%S This sentence indicates we're only interested in applications, we need to include a another goal???
...
{\color{red} in Russian there is no 'e" there and it's Aleksandr or perhaps Alexandr. But this name has a standard English version Alexander. I would be in favor of using the latter as this is how it's usually translated. Same for the last name: Alexandrov. Vitya }
