...
In Chapter 1, we discuss the Reshetnyak gluing theorem and apply it to a problem in billiards which was solved by Dmitri Burago, Serge Ferleger and Alexey Kononenko.

In Chapter 2, we discuss the globalization theorem of Hadamard--Cartan and apply it to the construction of exotic aspherical manifolds.

In Chapter 3, we discuss examples of Alexandrov spaces with curvature bounded above.
