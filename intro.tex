...
Here are some sources providing good  introduction to  Alexandrov spaces with curvature bounded above: 
...
\textit{metrics of non-negative curvature on the sphere, and only they, are isometric to closed convex surfaces in the Euclidean 3-space}. 
...
\end{itemize}
These two results together gave  a very intuitive geometric tool for studying  embeddings and bending of surfaces in the Euclidean space, and changed this subject dramatically.
...
Althogh the definitions of the two classes of spaces are similar, their properties and known applications are qute different.
