...
The idea that ``the essence of curvature lies in the general notion of a convex metric space and of a quadruple of points in such a space'' apparently originated with Wald, and is found in a single publication  on ``coordinate-free differential geometry'' \cite{wald}.
