...
We use our definition only for the open sets, for general sets it would be more natural to use \v{C}ech cohomology instead. %??? I don't get that. cohomology? V.
