...
and developed by the third author. 
...
A subset $K$ is called \emph{strongly two-convex} if any null-homotopic circle $\gamma\:\SS^1\to K$ is also null-homotopic in $K\cap \Conv[\gamma(\SS^1)]$.
...
For more on the subject, read \cite{petrunin-metricmin} and \cite{petrunin-stadler} by  Stephan Stadler and the third author, where a variation of Shefel's conjecture with a $\Cat{}{0}$ ambient space is discussed, and also a related result of Shefel in dimension~2. 
