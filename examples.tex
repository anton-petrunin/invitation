...
Choose a polytope $P$ in $\Omega$ such that the interior $\Int P$ contains the projections of all six broken lines and discs which contract all the loops created by them (3 discs is enough).
