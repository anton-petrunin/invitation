...
%Is it obvious that $\tilde (K)$ is simply connected? Also, in the statement of the theorem  the completion of the universal cover of $\Omega$ is denoted by $K$. here it's $\tilde K$. 
%It's better to use the same notations.
