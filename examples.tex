...
This chapter provides some conditions on a subset of Euclidean space which guarantee that the subset equipped with the induced length-metric forms a $\Cat{}{0}$ space.
In this chapter might help to understand what inner live in Alexandrov geometry is like.
...
$\Sigma_{\tilde p}$ is a $\Cat{}{0}$ space.
\end{clm}
