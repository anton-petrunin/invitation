...
To prove Proposition \ref{prop:two-hull-open}, apply Definition~\ref{def:two-convex} for  translations of the curve $\gamma$ by small vectors.
\qeds
...
so the $(x_1,\dots,x_{m-1})$-coordinate hyperplane is the tangent subspace to $S$ at $p$.
...
In this section we  consider inheritance of upper curvature bounds by subsets of Euclidean plane.
...
region whose boundary is a triangle in the induced intrinsic metric

triangle with concave sides.
Show that $\Delta$ equipped with induced intrinsic me	tric is thin.
\end{thm}
