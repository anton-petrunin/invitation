...
The obtained triangle $\trig xyz$ is null-homotopic in $K$,
...
that is, $\nabla_pf\ne0$ at any critical point $p$ of~$f|_S$.
...
Assume $K\subset\EE^m$ is a subgraph of a Lipschitz function $f\:\RR^2\to\RR$.
