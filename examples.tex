...
consider the plane $W$ through $p$  spanned by the first two principle directions.
...
To prove Proposition \ref{prop:two-hull-open}, apply Definition~\ref{def:two-convex} for parallel translations of the curve $\gamma$ by small vectors.
\qeds
...
This theorem is a baby case of the main result of \cite{a-b-b:CBA-m-w-b}, which is briefly  discussed at the end of chapter. 
