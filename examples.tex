...
The inclusion \ref{eq:VcVnV-0} makes it possible to apply recursively Reshetnyak gluing theorem \ref{thm:gluing}, in order to show that any finite union of $V_t$ forms a $\Cat{}{0}$ space.
