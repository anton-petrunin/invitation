...
%This space is a cone hence simply connected so why take the universal cover? V.
...
Choose a polytope $P$ in $\Omega$ such that its interior $\Int P$ contains the projections of all six broken lines and discs which contract all the loops created by them (it sufficient to take 3 discs).
