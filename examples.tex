...
Then there is a simple closed curve $\gamma$ in 
$W\z=\Pi_{n}$ 
encircling  $\hat U$ and contractible in $\Omega_{n-1}$.
%%??? Is this obvious? I can see why it's true but I wouldn't want to write a careful proof. V.
 Hence $\hat U$ must be entirely contained in $\Conv_2\Omega$ by two-convexity of  $\Conv_2\Omega$. 
...
%%??? I'm not sure what homology theory is the right one to take here and I don't think we should go into this. V.
