...
It states that for any three-dimensional manifold $M$ with nonempty boundary $\partial M$, if 
...
(2-faces)
of~$P$. 
By subdividing $F_i$ if necessary, we may assume that all $F_i$ are convex.
