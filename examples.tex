...
\end{clm}
Indeed,  for any fixed $x,y$ the function $f_{x,y}(t)=x^2-y^2 -2\cdot (x-t)^2$ is strictly concave in $t$ and hence $f_{x,y}(b)>\min\{f_{x,y}(a), f_{x,y}(c)\}$ which immediately implies \ref{eq:VcVnV-0}.
