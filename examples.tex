...
Suppose we already know that  $\Conv_2\Omega\supset\Omega_{n-1}$. Given a bounded component  $U$ of $\EE^3\backslash(\Pi_n\cup \Omega_{n-1})$, 
%it touches 
%["touches" means "intersects"] 
its boundary intersects $\Pi_{n}$ in
...
Any saddle surface in a $\Cat{}{\kappa}$ 
