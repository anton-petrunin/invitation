...
{\color{red}Denote by $k_1\le \dots\le k_{m-1}$ the principal curvatures of $S$ with respect to $\nu$ (note that if $K$ is convex, then  $k_1\ge 0$)}
...
\begin{thm}{Corollary}
Let $M$ be a Riemannian manifold with boundary~$\partial M$. 
Assume all the sectional curvatures of $M$ and $\partial M$ are bounded above by~$\kappa$.
Then $M$ is locally $\Cat{}{\kappa}$.
\end{thm}
