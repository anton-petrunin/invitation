...
There are no such examples in Eucliean space.
Indeed, the original Fáry--Milnor theorem implies that 
if $\beta$ is nontrivial knot in Euclidean space, then the
...
The solution is very similar to Lemma~\ref{lem:example-pi_infty}, but few changes are needed.
...
%\footnote{\color{red} V: I don't understand why this means that $(Q,\ell^\infty)$ is not injective }
