...
Use induction to prove that if in a spherical simplex $\tiangle$ every edge is at least $\tfrac\pi2$ then all its dihedral angles are at least~$\tfrac\pi2$.

The rest of the proof goes along the same lines as the proof of Flag condition~\ref{thm:flag}.
