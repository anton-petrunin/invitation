...
Note that $\Pi\cap \bar S$ contains a segment $[xy]$ passing $p$ with the ends at $\partial \bar S$.
...
the completion of the complement, equipped with length metric, 
 of the union of half-spaces in two three-dimensional spaces in $\EE^4$ containing~$0$. 
In particular $K'$ is a cone over a space $\Sigma$ which 
can be obtained as the completion of the sphere $\SS^3$ with  two two-dimensional hemispheres, say $H_1$ and $H_2$, removed.
