...
apply thinness of triangles $\trig pxy$ and $\trig qxy$, where $p$, $q$, $x$ and $y$ are as in the definition of $\Cat{}{\kappa}$ comparison,
...
For    $\Cat{}{0}$ both statements follow from convexity of distance functions to points in $\EE^2$ and thinness of triangles.
...
The only difference is that  the set $G$ is formed by squares with vertices at the  midpoints of some edges of the cubical analog. 
\qeds
