...
Note that in the original Fáry--Milnor theorem, the inequality is strict.
...
Therefore, in this exercise, one cannot trade compactness to properness. 
...
It remains to note that $\tilde {\spc{U}}$ can be obtained as a limit of $\spc{W}'_\eps$ as $\eps\to 0$, and apply~\ref{prop:cat-limit}.
