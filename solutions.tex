...
note that it exists.
%I feel this is too brief and would like to expand this. perhaps add an exercise that close curved are homotopic? V.
...
Use induction on the  to prove that if in a spherical simplex $\triangle$ every edge is at least $\tfrac\pi2$, then 
