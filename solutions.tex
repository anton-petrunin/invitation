...
Suppose $[xy]\cap A\cap B=\emptyset$. Then $z_0\in\partial (A\cap B)$.  Let $C=\{f\le f(z_0)\}$. Note that $C$ is compact, convex and has  smooth boundary. Suppose $z_0\in\partial  A \cap \Int B$. Then $A$ and $C$ touch at $z_0$ and we can set $\dot A$   to be the uniquely defined supporting hyperspace to $A$  at $z_0$ and $\dot B$   to be any hyperspace containing $B$. The case $z_0\in\partial B \cap \Int A$ is treated similarly.


Finally, suppose
 $z_0\in\partial A\cap\partial B$. Then  set  $\dot A$ ($\dot B$)  to be the uniquely defined supporting hyperspace to $A$ ($B$) at $z_0$ containing $A$ ($B$).  
\qeds
