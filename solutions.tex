...
\parit{Comment.}
There are a compact metrizable contractible and locally contractible spaces that do not admit a $\CAT(1)$ length metrics \cite{460763}.
...
Think that $G$ is made from the squares parallel to the squares of the cubical complex which meet the edges of the complex orthogonally at their midpoints.
