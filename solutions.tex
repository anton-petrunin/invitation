...
Consider the space $c_0$ of all sequences converging to zero equipped with supnorm.
The unit ball in $c_0$ is almost what you want --- there is no unique shortest curve between points. 
All we need now is to enhance \emph{bypasses} and to give disadvantage to emph{bstraight lines}. 
...
\parbf{Exercise~\ref{ex:haudorff-convergence}.}
