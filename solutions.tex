...
Since  $\Omega$ is not two-convex, then by definition there is a curve $\gamma$ which lies in the intersection of a plane $W_0$ and $\Omega$, 
...
By a general position argument, we can assume that such a point lies in the interior of $Q$.
