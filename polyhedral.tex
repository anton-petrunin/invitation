...
In this chapter we introduce locally $\Cat[0]$ spaces and show that universal cover of locally $\Cat[0]$ space forms a $\Cat[0]$ space. 
The latter implies that any locally $\Cat[0]$ space is aspherical; 
that is its universal cover is contractible.
This observation is used to construct exotic aspherical manifolds.
...
Assume $\spc{U}$ is a locally $\Cat{}{1}$ space and the construction $\alpha\mapsto\gamma_\alpha$ provided by Corollary \ref{cor:path-geod}.
