...
Let $\spc{U}$ be a simply connected, proper length locally $\Cat{}{0}$ space.
...
Any compact  {\color{red} length} locally $\Cat{}{0}$ space that contains no closed local geodesics is $\Cat{}{0}$.
...
Prove that any compact {\color{red} length} locally $\Cat{}{0}$ space that is not $\Cat{}{0}$ contains a \index{geodesic circle}\emph{geodesic circle}, 
...
Choose a simplex $\sigma$ which contains  the point $\gamma(t_0)$ {\color{red} for some $t_0$}.
...
The link of each cube in a cubical complex {\color{red}(defined similarly to the link of a simplex in a simplicial complex)} admits a natural 
...
This observation can be used to construct {\color{red} interesting} examples of  aspherical spaces. 
