...
Analogously, a length space $\spc{P}$ is called  a 
\emph{spherical polyhedral space} 
if it admits a finite triangulation $\tau$ 
such that every simplex in $\tau$ is isometric to a simplex in a unit sphere of appropriate dimension.
...
\begin{thm}{Corollary}\label{cor:closed-geod-cat} Any locally $\Cat{}{0}$ compact space which contains no closed geodesics is $\Cat{}{0}$.
...
The subset of $\spc{T}_n$ corresponding to the given topological tree $\tau$ can be identified with the ocotant
