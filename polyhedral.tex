...
The following lemma and its proof were suggested to us by %Alexander 
Lytchak.  
...
The following example was proved by %Michael 
...
some of which are discussed in the survey \cite{davis-survey} by %Michael 
Davis.

The following Proposition was proved by %Fredric 
Ancel, 
%Michael 
Davis and 
%Craig 
Guilbault in \cite{ADG}. 
...
A similar construction was used by %Michael 
Davis, 
%Tadeusz 
Januszkiewicz and 
%Jean-Fran\c{c}ois 
Lafont \cite{davis-januszkiewicz-lafont}
