...
In this chapter we introduce locally $\Cat{}{\kappa}$ spaces and show that universal cover of proper locally $\Cat{}{0}$ length space forms a $\Cat{}{0}$ space. 
...
In this section we will study behavior of local geodesics in the locally $\Cat{}{\kappa}$  spaces.  
...
$\Cat{}{1}$ case is done the same way, but one has to assume in addition that $R<\pi$.
\qeds
