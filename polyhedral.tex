...
and such that the arc $\gamma_n|\II$ is minimizing for all large $n$.
...
Recall that \emph{path} denotes a curve parametrized by $[0,1]$.
...
Join of two paths will be denoted with ``$*$'';
