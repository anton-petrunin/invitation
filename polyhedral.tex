...
Since both $V_v$ and $W$ are contractable, the identity map of  their common boundary $\Sigma$ can be extended to a homotopy equivalence between $V_v$ and $W$ rel boundary.
Therefore the identy map on the $\spc{N}$ extends to homotopy equivalences 
