...
that is, its universal cover is contractible. %??? I do not think "proper length locally $\Cat{}{0}$" is easy to read???
...
Therefore all proper length, locally $\Cat{}{0}$ spaces %that are complete 
are \index{aspherical}\emph{aspherical};
that is, they have contractible universal covers.
This observation can be used to construct %??? +"interesting" --- I do not like it --- intersting has no meaning for me. A.???
