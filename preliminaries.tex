...
A curve $\gamma\:\II\to \spc{X}$  is called a \emph{local geodesic}\index{geodesic!local geodesic}, if for any $t\in\II$ there is a neighborhood $U$ of $t$ in $\II$ such that the restriction $\gamma|_U$ is a constant-speed geodesic. 
{\color{red} !!! IMO it would be more consistent to call $\gamma$ a local geodesic if it's locally a geodesic in the sense of the original definition (in particular it's unit speed)!!!}
