...
In a  metric space $\spc{X}$, show that if a sequence of closed sets $(A_n)_{n=1}^\infty$ converges  to  
a closed set $A_\infty$, then $A_\infty$ is the set of all limits of convergent sequences $(x_n\in A_n)_{n=1}^\infty$.
\end{subthm}
\begin{subthm}{}
Show  the converse holds if  $\spc{X}$ is proper, but may fail otherwise.
\end{subthm}
\end{thm}
