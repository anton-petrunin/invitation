...
{\color{red} ??? I think this is too fast. why is it obvious that a complete space which has a compact $\eps$-net for any $\eps$ is compact?}
\claimqeds
...
\end{thm}
{\color{red}??? I think this exercise should be moved to Chapter 2 somewhere.  CAT(k) is not defined yet.}
