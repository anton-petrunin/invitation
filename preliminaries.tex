...
A \emph{geodesic path}\index{geodesic path} is a constant-speed geodesic parameterized by $[0,1]$.
...
A curve $\gamma\:[0,1]\to \spc{X}$  is called a \emph{local geodesic path}\index{geodesic!local geodesic}, if for any $t\in\II$ there is a neighborhood $U$ of $t$ in $\II$ such that the restriction $\gamma|_U$ is a constant-speed geodesic. 
...
\begin{thm}{Exercise}
\label{ex:hausdorff-conv}\begin{subthm}{}
