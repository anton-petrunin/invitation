...
%
%??? I think it was too fast before. why is it obvious that a complete space which has a compact $\eps$-net for any $\eps$ is compact?}
\claimqeds
...
%Show that the space of geodesic directions at any point is complete.
%\end{thm}
%??? Moved to chapter 2
