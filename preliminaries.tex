...
In this case the image of $\gamma$ is denoted by $[p q]$\index{$[p q]=[p q]_{\spc{X}}$ (geodesic)} and with an abuse of notation  we also call it a \index{geodesic}\emph{geodesic}.
