...
To define $s(t,\tau)$, consider three rays $\tilde\gamma_1$, $\tilde\gamma_2$, $\tilde\gamma_3$ on a Euclidean plane starting at one point, such that $\mangle(\tilde\gamma_1,\tilde\gamma_2)\z=\alpha_{12}+\eps$, $\mangle(\tilde\gamma_2,\tilde\gamma_3)\z=\alpha_{23}+\eps$ and $\mangle(\tilde\gamma_1,\tilde\gamma_3)\z=\alpha_{12}+\alpha_{23}+2\cdot \eps$.
...
\caption{Convergence of $\RR_{\ge0}$ and $\RR$.}
\label{pic-500}
\end{figure}
