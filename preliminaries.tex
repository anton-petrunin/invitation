...
\emph{Hausdorff convergence} was introduced by Felix Hausdorff in \cite{hausdorff},
but a couple of years later an equivalent definition was given by Wilhelm Blaschke in~\cite{blaschke}.
...
instead of
{}\emph{Hausdorff--Blaschke--Frol\'{\i}k--Wijsman convergence}.
